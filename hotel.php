...
{ 
  ...
  $sql="INSERT INTO choice (id,hid,mid,pid,tid,vid) VALUES ('$id','$hotel','$mid','$pid','$tid','$vid')";
...
while ($row = mysqli_fetch_array($query)) {
   ...
   $sqll="INSERT INTO budget (hcost,vcost,tcost,pcost,mcost,id,cid) VALUES ('$thc','$vcost','$tcost','$pcost','$mcost','$id','$cid')";
        mysqli_query($db,$sqll);
...
$getinfo1 = "select hcost,vcost,tcost,fcost,pcost,tancost,mcost from budget where id='$id' and cid='$cid'";
...
while ($row = mysqli_fetch_array($query1)) {
	...
	$sqll ="UPDATE budget SET total='$total' WHERE id='$id' and cid='$cid'";
